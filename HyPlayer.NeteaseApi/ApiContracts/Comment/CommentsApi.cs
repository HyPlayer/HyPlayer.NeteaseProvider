...
namespace HyPlayer.NeteaseApi.ApiContracts.Comment
{
    ...
    public class
        CommentsApi : EApiContractBase<CommentsRequest, CommentsResponse, ErrorResultBase, CommentsActualRequest>
    {
        public override string IdentifyRoute => "/comments";

        public override string Url { get; protected set; } =
            "https://interface3.music.163.com/eapi/v2/resource/comments";
    ...
    public class CommentsResponseData
    {
        ...
        [JsonPropertyName("currentCommentTitle")]
        public string? CurrentCommentTitle { get; set; }
