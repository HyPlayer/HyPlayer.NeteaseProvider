...
public class NavigationViewService : INavigationViewService
{
    ...
    private void OnItemInvoked(NavigationView sender, NavigationViewItemInvokedEventArgs args)
    {
        ...
        else
        {
            ...
            if (selectedItem?.GetValue(NavigationViewHelper.NavigateToProperty) is string pageKey)
            {
                _navigationService.NavigateTo(pageKey, null, new EntranceNavigationTransitionInfo(), TargetFrameOption.ShellFrame);
            }
        }
    }
